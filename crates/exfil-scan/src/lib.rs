...
//! [`Pipeline`](exfil_task::Pipeline), which the engine drives per file. This
...
//! # Rust notes
//!
//! This crate is exfil's *plugin system*, built from two Rust features:
//!
...
use exfil_core::{Match, Rule};
use exfil_task::{Artifact, ArtifactKind, FileTask, Pipeline};
use regex::Regex;
